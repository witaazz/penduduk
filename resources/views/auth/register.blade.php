    ...
    <div class="relative py-3 sm:max-w-xl sm:mx-auto">
        ...
        <div class="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
            ...
            <div class="max-w-md mx-auto">
                <form class="flex flex-col gap-4 pb-4" method="POST" action="{{ route('register.post') }}">
                    @csrf
                    <h1 class="mb-4 text-2xl font-bold  dark:text-gray-900">Register</h1>
                    <div>
                        <div class="mb-2">
                            <label class="text-sm font-medium text-gray-900 dark:text-gray-900" for="email">Nama:</label>
                        </div>
                        <div class="flex w-full rounded-lg pt-1">
                            <div class="relative w-full">
                                <input class="block w-full border disabled:cursor-not-allowed disabled:opacity-50 bg-gray-50 border-gray-300 text-gray-900 focus:border-cyan-500 focus:ring-cyan-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-cyan-500 dark:focus:ring-cyan-500 p-2.5 text-sm rounded-lg" id="name" type="text" name="name" placeholder="Masukkan nama" value="{{ old('name') }}">
                                <span>
                    ...
                    <div>
                        ...
                        <div class="flex w-full rounded-lg pt-1">
                            <div class="relative w-full">
                                <input class="block w-full border disabled:cursor-not-allowed disabled:opacity-50 bg-gray-50 border-gray-300 text-gray-900 focus:border-cyan-500 focus:ring-cyan-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-cyan-500 dark:focus:ring-cyan-500 p-2.5 text-sm rounded-lg" id="password" type="password" name="password" Placeholder="Masukkan password">
                                <span>
                ...
                <div class="min-w-[270px]">
                    <div class="mt-4 text-center dark:text-gray-900">Already have an account?
                        <a class="text-blue-500 underline hover:text-blue-600" href="{{ route('login') }}">Sign in
                        </a>
                    </div>
                </div>
            </div>
